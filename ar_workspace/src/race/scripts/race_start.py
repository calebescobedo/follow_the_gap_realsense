...
# WALL_FOLLOW PARAMS
MINIMUM_FRONT_DIST = 2.5 # For any dc value smaller than this, take a sharp turn (STATE: CORNERING)
STRAIGHT_THRESHOLD = 0.3 # As long as abs(dr - dl) is within this, no turning needed

WALL_FOLLOW_VELOCITY = .15
WALL_FOLLOW_TURN_ANGLE = 0.1
