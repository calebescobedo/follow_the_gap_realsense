...
"""autogenerated by genpy from ros_pololu_servo/pololu_trajectoryActionResult.msg. Do not edit."""
import sys
...
class pololu_trajectoryActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "ros_pololu_servo/pololu_trajectoryActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ros_pololu_servo/pololu_trajectoryResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(pololu_trajectoryActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = ros_pololu_servo.msg.pololu_trajectoryResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = ros_pololu_servo.msg.pololu_trajectoryResult()
